...
import { MOODBOARD_ACHIEVEMENTS_ADDRESS, MOODBOARD_ACHIEVEMENTS_ABI, ACHIEVEMENT_TYPES, getAchievementTypeNumber } from '../config/contracts';
...
export const useNFT = () => {
  ...
  const useHasAchievement = (achievementType) => {
    ...
    return useReadContract({
      address: MOODBOARD_ACHIEVEMENTS_ADDRESS,
      abi: MOODBOARD_ACHIEVEMENTS_ABI,
  ...
  const mintAchievement = async (achievementType) => {
    ...
    console.log('Contract address:', MOODBOARD_ACHIEVEMENTS_ADDRESS);
