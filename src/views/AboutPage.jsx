      ...
      <header className="landing__hero" style={{ paddingBottom: 0 }}>
        <nav className="landing__nav">
          <Link to="/" className="landing__brand">
            <img src="/logo.png" alt="MoodBoard logo" className="landing__brand-mark" />
            <span className="landing__brand-name">MoodBoard</span>
          </Link>
          ...
          <div className="landing__nav-actions">
            <a className="landing__button landing__button--icon" href="https://github.com/shirsakm/moodboard" target="_blank" rel="noreferrer" aria-label="GitHub">
      ...
      <main className="about__content">
        ...
        <section className="about__section">
          ...
          <p>
            ...
            And here I am, presenting to you ✨ MoodBoard ✨.
          </p>
          <p>
        ...
        <section className="about__section">
          ...
          <p>
            ...
            MoodBoard is designed from the ground up to be easily self-hosted.
          </p>
          <p>
          ...
          <ul>
            ...
            <li><strong>Desktop-First UI:</strong> Unlike mobile-only apps, MoodBoard features a layout optimized for desktop use.</li>
        ...
        <section className="about__section">
          ...
          <p>
            Despite balancing this project with academics, MoodBoard has continued to grow. 
        ...
        <section className="about__section">
          ...
          <p>
            MoodBoard is built for mindful teams and solo creators. It's a mood logger and journal that won't suck your data and soul.
            It is, and always will be, free and open source.
          </p>
          <p>
            If you find this project useful, please consider leaving a star on the <a href="https://github.com/shirsakm/moodboard">GitHub repo</a>—it really helps new users trust lesser-known projects.
          </p>
        </section>
      </main>

      <footer className="landing__footer">
        <p className="landing__footer-note">© 2025 MoodBoard. Open source and privacy-first.</p>
        <div className="landing__footer-links">
          <Link to="/privacy">Privacy</Link>
          <Link to="/terms">Terms</Link>
          <a href="mailto:hello@moodboard.com">Contact</a>
        </div>
      </footer>
    </div>
  );
