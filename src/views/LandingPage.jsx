...
const LandingPage = () => {
  return (
    <div className="landing">
        ...
        <div className="landing__hero-body">
          <div className="landing__hero-copy">
            ...
            <div className="landing__cta-group">
              ...
              <a className="landing__button landing__button--ghost" href="https://github.com/shirsakm/moodboard">View on GitHub</a>
            </div>
          </div>
      ...
      <section id="why-moodboard" className="landing__section landing__section--alt">
      ...
      <section id="cta" className="landing__section landing__section--cta">
        <div className="landing__cta">
          ...
          <div className="landing__cta-buttons">
            ...
            <a className="landing__button landing__button--ghost" href="https://github.com/shirsakm/moodboard" target="_blank" rel="noreferrer">View on GitHub</a>
          </div>
        </div>
      </section>
